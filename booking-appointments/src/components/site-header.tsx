...
export function SiteHeader({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-40 border-b border-[var(--color-border)] bg-[rgba(254,249,240,0.84)] dark:bg-[rgba(13,8,32,0.88)] backdrop-blur-xl",
        compact && "relative rounded-[2rem] border",
      )}
    >
